...
var finalPaid = function (cost) {
  return cost + calculateTip(cost);
};

var bills = [124, 48, 268];
var tipsAmounts = [calculateTip(124), calculateTip(48), calculateTip(268)];
var finalAmounts = [finalPaid(124), finalPaid(48), finalPaid(268)];
